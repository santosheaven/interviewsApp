...
COMMENT ON COLUMN COMPANY.CC_ID IS 'Identifier';
...
ALTER TABLE PROCESS_INTERVIEW (
    ADD CONSTRAINT PROCESS_INTERVIEW_FK1 FOREIGN KEY (CC_ID)
    REFERENCES COMPANY_CONTACT (CC_ID) ON
DELETE
CASCADE ENABLE,
ADD CONSTRAINT PROCESS_INTERVIEW_FK2 FOREIGN KEY (SI_ID)
    REFERENCES STATUS_INTERVIEW (SI_ID) ON
DELETE
CASCADE ENABLE,
ADD CONSTRAINT PROCESS_INTERVIEW_FK3 FOREIGN KEY (CA_ID)
